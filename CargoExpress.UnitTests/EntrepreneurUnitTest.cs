...
public class EntrepreneurUnitTest
{
    ...
    public async Task GetAll_Entrepreneur_Success()
    {
        ...
        var entrepreneur1 = new Entrepreneur("Lucho Vega", "986559213", "20000000002", "logo.com/image.jpeg", 1, userEntrepreneur1);

        var userEntrepreneur2 = new User("carlos@gmail.com", "contra1234567");
        var entrepreneur2 = new Entrepreneur("Carlos Perez", "986559214", "20000000003", "logo2.com/image.jpeg", 2, userEntrepreneur2);
    ...
    public async Task GetById_Entrepreneur_Success()
    {
        ...
        var userEntrepreneur1 = new User("lucho@gmail.com", "contra1234567");
        var entrepreneur = new Entrepreneur("Lucho Vega", "986559213", "20000000002", "logo.com/image.jpeg", 1, userEntrepreneur1);
